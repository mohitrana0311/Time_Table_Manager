...
export default function LoginForm(props) {
    ...
    return (
        <div className="outer">
            <div className="left">
                <div className="sociallogin google" onClick={handlesocial} id="/google">
                    <FontAwesomeIcon icon={faGoogle} className="iconss" />
                    <span>login with google</span>
                </div>
                <div className="sociallogin facebook" onClick={handlesocial} id="/facebook">
                    <FontAwesomeIcon icon={faFacebook} className="iconss" />
                    <span>login with facebook</span>
                </div>
                <div className="sociallogin github" onClick={handlesocial} id="/github">
