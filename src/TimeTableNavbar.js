        ...
        <div className="classs">
            ...
            <div className="timetablenavbar">
                <div className="navbar-home-button">
                    <button onClick={tt} className="timetable slotted" value="timetable" {...isActive === 1 && { style: { backgroundColor: 'red' } }}> TimeTable</button>
                    <button onClick={at} className="attendence slotted" value="attendence" {...isActive === 2 && { style: { backgroundColor: 'red' } }}>Attendence</button>
                    <button onClick={td} className="today slotted" value="today" {...isActive === 3 && { style: { backgroundColor: 'red' } }}>Today</button>
                </div>
